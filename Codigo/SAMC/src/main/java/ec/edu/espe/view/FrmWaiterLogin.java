...
public class FrmWaiterLogin extends javax.swing.JFrame {

    /**
     * Creates new form FrmWaiterLogin
     */
    ...
    private void btnAccessActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccessActionPerformed
        ...
        MongoCollection<Document> collection = database.getCollection("pw_waiter");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmWaiterLogin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
